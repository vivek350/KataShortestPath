...
class ShortestPath {
    //Creates a dist 2D array with zeroes, then calculates the shortest path starting from last column to first 
    ...
    //Sorts the shortest path from all the available shortest paths available
    ...
    //Finds the minimum length from the shortest sorted path and returns the value
